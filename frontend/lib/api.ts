...
export const API_CONFIG = {
  ...
  REALTIME_URL: typeof window !== 'undefined'
    ...
    : process.env.NEXT_PUBLIC_REALTIME_URL || 'wss://all4youws-bxjj.onrender.com'
};
...
export const getRealtimeUrl = (): string => {
  ...
  if (typeof window !== 'undefined' && window.location.hostname !== 'localhost') {
    return 'wss://all4youws-bxjj.onrender.com';
  }
  
  // In development or SSR, use environment variables
  return process.env.NEXT_PUBLIC_REALTIME_URL || 'wss://all4youws-bxjj.onrender.com';
};